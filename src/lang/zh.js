export default {
    ...
    dbConnect: {
        ...
        demoDbConnect: {
            ...
            mysql_defKey: 'MySQL',
            'mysql-information_schema_defKey': 'MySQL(使用information_schema查询表结构)',
            ...
            kingbase_defKey: 'Kingbase(人大金仓)',
            maxcompute_defKey: 'MaxCompute',
            sqlite_defKey: 'SQLite',
            'hive-MySQL_defKey': 'Hive(MySQL做metastore)',
            'hive-PostgreSQL_defKey': 'Hive(PostgreSQL做metastore)',
            gbase_defKey: 'GBase',
        },
        configExample: '配置示例：',
        connectSuccess: '连接成功',
