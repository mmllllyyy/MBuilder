export default {
    ...
    entityUniqueDefKeyError: '数据表或透视表已经存在，请修改,重复数据表或透视表有[{entities}]',
    ...
    exportSql: {
        entity: '导出数据表/透视表',
        exportEntityAll: '默认导出所有数据表/透视表',
        exportDictAll: '默认导出所有数据字典',
        exportType: ['自定义', '全部', '建表/透视表语句', '建索引语句', '基本代码'],
        currentSelectEntity: '当前已选择数据表/透视表数量：{count}',
        currentSelectDict: '当前已选择数据字典数量：{count}',
        preview: '预览',
        export: '导出',
        pickEntity: '选择数据表/透视表',
        pickDict: '选择数据字典',
        exportData: '导出内容',
